...
float slope = 15.28; //create global variable for slope for a Dual-Range Force Sensor +/-10N range
float intercept = -3.23; //create global variable for intercept for a Dual-Range Force Sensor +/-10N range
String units = "ppt"; //create global variable for units for a Dual-Range Force Sensor
